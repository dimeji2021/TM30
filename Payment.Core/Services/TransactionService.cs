        ...
        public async Task<ResponseDto<string>> Transfer(TransferRequestDto request, string walletId) 
        {
            try
            {
                ...
                if (recipient == null)
                {
                    ...
                    TransferDataRequestDto transferRequest = TransferRequest(newRecipient.data.recipient_code, request.Amount*100);
                    ...
                    Transaction transaction = Transaction(InitiateTransfer.Data.reference, InitiateTransfer.Data.Amount/100,
                   ...
                   if( await VerifyTransferAsync(InitiateTransfer.Data.reference))
                    {
                        _logger.Information("Transfer Initiated when specific recipient from list is null");
                        return ResponseDto<string>.Success("Transaction successful", $"Transfer from {wallet.Name}");
                    }
                ...
                TransferDataRequestDto recipientTransfer = TransferRequest(recipient.recipient_code, request.Amount *100);
                ...
                Transaction Wallettransaction = Transaction(InitiateRecipientTransfer.Data.reference, InitiateRecipientTransfer.Data.Amount/100, walletId,
                ...
                var verifyTransaction = await VerifyTransferAsync(InitiateRecipientTransfer.Data.reference);
